...
const PassengerInfo = forwardRef(
  (
    {
      isGiftVoucher,
      isFlightVoucher,
    ...
    const passengerCount = (() => {
      ...
      if (activitySelect === "Redeem Voucher") {
        const q = parseInt(
          selectedVoucherType?.quantity ?? chooseFlightType?.passengerCount,
          10,
        );
      ...
      const isVoucherDriven =
        chooseFlightType?.type === "Flight Voucher" ||
        activitySelect === "Book Flight";
      if (isVoucherDriven) {
        // Prefer explicit quantity prop
        if (
          selectedVoucherType?.quantity !== undefined &&
          selectedVoucherType?.quantity !== null
        ) {
          const extracted =
            typeof selectedVoucherType.quantity === "string"
              ? (selectedVoucherType.quantity.match(/\d+/)?.[0] ??
    ...
    useEffect(() => {
      ...
      const computeAndSet = () => {
        ...
        const clampedIndex = Math.max(
          0,
          Math.min(newCurrentIndex, passengerCount - 1),
        );
      ...
      container.addEventListener("touchstart", updateScrollButtons, {
        passive: true,
      });
      container.addEventListener("touchmove", updateScrollButtons, {
        passive: true,
      });
    ...
    const isPassengerComplete = (passenger, index) => {
      ...
      return (
        hasFirstName && hasLastName && hasWeight && hasPhone && hasValidEmail
      );
    };
    ...
    const handleWeatherRefundChange = (index) => {
      setPassengerData((prevData) => {
        ...
        updatedData[index] = {
          ...updatedData[index],
          weatherRefund: !updatedData[index].weatherRefund,
        };
        return updatedData;
      });
    ...
    const validateFields = (setErrors = true) => {
      ...
      passengerData.forEach((passenger, index) => {
        ...
        if (index === 0) {
          if (!passenger.phone?.trim() || !passenger.countryCode)
    ...
    useEffect(() => {
      ...
      const isValid = passengerData.every((p, idx) =>
        isPassengerComplete(p, idx),
      );
    ...
    useEffect(() => {
      ...
      if (
        currentPassenger &&
        isPassengerComplete(currentPassenger, currentPassengerIndex)
      ) {
    ...
    return (
      ...
      >
        <div
          className="tab_box presger-scroll"
          style={{
            ...
            ...(activitySelect === "Buy Gift"
              ...
              : {
                  ...
                  maxHeight:
                    !isMobile && isMultiPassenger ? "550px" : undefined, // Desktop: limit outer height
                }),
          }}
          ...
          {showNextToast &&
            (() => {
              ...
              const nextSectionId = getNextSectionId
                ? getNextSectionId("passenger-info")
                : null;
                ...
                setTimeout(() => {
                  ...
                  if (!target) {
                    ...
                    if (label) {
                      ...
                      if (btn)
                        target = btn.closest(".accordion-section") || btn;
                    }
                  }
          ...
          {enableMobileCarousel && isMobile && passengerCount > 1 ? (
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <div
                  className="passenger-cards-container"
                  style={{
                  ...
                  {[...Array(passengerCount)].map((_, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="all-pressenger"
                        key={index}
                        style={{
                          marginBottom: isMobile ? 0 : 12,
                          padding:
                            activitySelect === "Buy Gift" ? "16px" : "5px",
                          ...
                          >
                            ...
                            >
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  handlePassengerInputChange(index, e)
                                }
                                required
                                ...
                                placeholder={
                                  !isPreviousPassengerComplete(index)
                                    ? "Complete previous passenger first"
                                    : "First Name"
                                }
                              />
                                    ...
                                    style={{
                                      ...
                                      backgroundColor:
                                        !isPreviousPassengerComplete(index)
                                          ? "#f3f4f6"
                                          : "#ffffff",
                                      color: !isPreviousPassengerComplete(index)
                                        ? "#9ca3af"
                                        : "#374151",
                                      cursor: !isPreviousPassengerComplete(
                                        index,
                                      )
                                        ? "not-allowed"
                                        : "pointer",
                ...
                {(() => {
                  ...
                  return ordered.map((index) => {
                    ...
                    return (
                      <div
                        id={`passenger-${index + 1}`}
                        className={`all-pressenger ${activitySelect === "Buy Gift" ? "Purchaser" : ""}`}
                        key={index}
                        style={{
                          marginBottom:
                            activitySelect === "Buy Gift"
                          ...
                          zIndex: 1,
                          borderTop:
                            isMobile && !isCombinedMobile && index > 0
                              ? "4px solid #3b82f6"
                              : "none",
                        }}
                      >
                            ...
                            <div style={{ width: "100%", minWidth: 0 }}>
                              ...
                              <input
                                ...
                                style={{
                                  ...
                                  border: "1px solid #d1d5db",
                                  borderRadius: "6px",
                                  backgroundColor: !isPreviousPassengerComplete(
                                    index,
                                  )
                                    ? "#f3f4f6"
                                    : "#ffffff",
                                  color: !isPreviousPassengerComplete(index)
                                    ? "#9ca3af"
                                    : "#374151",
                                  cursor: !isPreviousPassengerComplete(index)
                                    ? "not-allowed"
                                    : "text",
                                  fontWeight: "400",
                              ...
                              <div style={{ width: "100%", minWidth: 0 }}>
                                ...
                                >
                                  ...
                                  <ReactTooltip
                                    ...
                                    place="top"
                                    content="If unknown, enter 0 and contact us before your flight. If exceeding weight limit please contact the office."
                                  />
                                </label>
                                <input
                                  type="text"
