            ...
            {isMobile ? (
                ...
                <div style={{ position: 'relative', width: '100%' }}>
                    ...
                    <div className="experience-scroll-outer" style={{ 
                        ...
                        />
                        <div style={{ padding: '12px', width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', height: 'auto' }}>
                            ...
                            <div style={{ fontSize: 13, color: '#444', marginBottom: 6, lineHeight: '1.35' }}>{experience.desc}</div>
