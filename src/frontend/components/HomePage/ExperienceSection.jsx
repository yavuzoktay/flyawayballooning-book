...
const ExperienceSection = ({ isRedeemVoucher, setChooseFlightType, addPassenger, setAddPassenger, activeAccordion, setActiveAccordion, setAvailableSeats, chooseLocation, isFlightVoucher, isGiftVoucher, onSectionCompletion, isDisabled = false }) => {
    ...
    const isBristol = useMemo(() => chooseLocation === 'Bristol', [chooseLocation]);
    ...
    const getExperiences = useMemo(() => {
        ...
        const experiencesArray = [
            ...
            },
            {
                ...
                originalPriceValue: privatePriceState.originalPriceValue || privatePrice || 900,
        ...
        } else if (allowedFlightTypes.length === 0 && locationPricing?.experiences) {
    ...
    }, [experiences, experiencesLoading, locationPricing, isBristol, activitiesWithFlightTypes, chooseLocation, getExperiences, cacheTimestamp]);
                ...
                <div style={{ position: 'relative', width: '100%' }}>
                    ...
                    <div className="experience-scroll-outer" style={{ 
                        ...
                        <div style={{ padding: '10px', width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', height: '100%' }}>
                            ...
                            <div style={{ fontSize: 13, color: '#444', marginBottom: 6, lineHeight: '1.3', flex: '1' }}>
                                {experience.desc}
                            </div>
