            ...
            if (dayPointer < startDate) {
                ...
                days.push(
                    <div
                        ...
                        style={{
                            opacity: isPastDate ? 1 : (soldOut ? 1 : (isAvailable ? (isLocationAndExperienceSelected ? 1 : 0.3) : 0.5)),
                            cursor: isInteractive ? 'pointer' : 'not-allowed',
                            background: isSelected ? '#56C1FF' : isPastDate ? '#f5f5f5' : soldOut ? '#888' : isAvailable ? '#61D836' : '',
                            color: isPastDate ? '#666' : soldOut ? '#fff' : isAvailable ? '#fff' : '#888',
                            ...
                            animation: (pulse && !isPastDate) ? 'pulseAnim 1.2s infinite' : 'none',
                            display: 'flex',
