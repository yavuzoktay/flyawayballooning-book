            ...
            <div className="book_data_active">
                ...
                {activitySelect === 'Redeem Voucher' && (
                    <>
                        ...
                        <div className="book_data_active" onClick={() => setActiveAccordion("voucher-type")}> <div className={`row-1 ${selectedVoucherType ? 'active-card-val' : ''}`}> <span className="active-book-card"></span><div className="book-cont final-active-book-cont"><div className="active-book-left"><h3>Voucher Type</h3><p>{selectedVoucherType ? selectedVoucherType.title : "Not Selected"}</p></div><div className="active-book-right"><p>{selectedVoucherType ? "£" + selectedVoucherType.price : ""}</p></div></div></div></div>
