...
const Index = () => {
    ...
    const safeAutoOpenAccordion = React.useCallback((sectionId) => {
        ...
        if (sectionId === 'live-availability' &&
            (capturedActive === 'passenger-info' || currentActive === 'passenger-info')) {
            return;
        }
        ...
        if (chooseLocation && activeAccordion === "live-availability") {
            ...
            if (isShopifyFlow) {
                ...
                try {
                    ...
                    if (chooseFlightType && chooseFlightType.type && chooseFlightType.type !== 'Private Charter') {
                        let flightTypeForBackend;
                        if (chooseFlightType.type === 'Shared Flight') {
                            flightTypeForBackend = 'Shared';
                        } else {
    ...
    React.useEffect(() => {
        ...
        if (activeAccordion === 'recipient-details' || activeAccordion === 'passenger-info') {
            return;
        }
